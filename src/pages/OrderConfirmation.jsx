...
import { CheckCircle, Package, Truck, CreditCard, MapPin, Mail, Phone, Calendar, Clock, Info, X, AlertCircle } from "lucide-react";
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-orange-800">
                ...
                <p className="leading-relaxed">
                  Thank you for placing order on the Gorakhpur rentals our team will contact you soon for further details.
                </p>
                <p className="mt-3 font-medium">Please Note:</p>
                <ul className="mt-2 space-y-1 text-xs">
                  <li>• You have to provide a <strong>Refundable amount of ₹5,000</strong> at the time of product pickup</li>
                  <li>• A <strong>valid government ID proof</strong> is required</li>
                  <li>• The amount will be refunded to you at the time of return of the product</li>
                </ul>
              </div>
            </div>
          </div>
